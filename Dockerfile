...
LABEL org.label-schema.vcs-url="https://github.com/usdot-fhwa-stol/CARMAVelodyneLidarDriver/"
LABEL org.label-schema.vcs-ref=${VCS_REF}
LABEL org.label-schema.build-date=${BUILD_DATE}

COPY --from=setup /home/carma/install /opt/carma/app/bin

CMD [ "wait-for-it.sh", "localhost:11311", "--", "roslaunch", "velodyne_lidar_driver_wrapper", "velodyne_lidar_wrapper.launch", "remap_ns:=/saxton_cav/drivers" ]
